# Task 6 - точно с 5 заданием, но статус False
...
Johanni = User('Johanni L.', 'PHP Developer', 'Partner & Contributer', '@lodev09', 'False')
Roberto = User('Roberto R.', 'Ralls Developer', 'Partner & Contributer', '@sildur', 'False')
